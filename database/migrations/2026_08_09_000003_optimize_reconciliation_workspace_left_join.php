...
return new class extends Migration
{
    public function up(): void
    {
        ...
        DB::statement("
            ...
            -- 2. Unmatched bank entries (Unrecorded Bank Entry) - Optimized using Anti-Join (LEFT JOIN ... IS NULL)
            SELECT
            ...
            LEFT JOIN import_jobs AS bank_job ON bank_job.id = bank_statements.import_job_id
            LEFT JOIN internal_disbursements ON internal_disbursements.bank_statement_id = bank_statements.id
            WHERE internal_disbursements.id IS NULL
        ");
    }
