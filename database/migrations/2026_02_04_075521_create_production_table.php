...
return new class extends Migration
{
    public function up(): void
    {
        Schema::create('productions', function (Blueprint $table) {
            ...
            $table->decimal('theoretical_lkg', 12, 3);
            $table->decimal('actual_lkg', 12, 3);
            $table->decimal('pshr_net_lkg', 12, 3);
            $table->decimal('pdpa_lkg', 12, 3);
            $table->decimal('association_dues_lkg', 12, 3);
            $table->decimal('actual_mol', 12, 3);
            $table->decimal('pshr_net_mol', 12, 3);
            $table->decimal('pdpa_mol', 12, 3);
